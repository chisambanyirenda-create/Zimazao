  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col bg-background">
      ...
      <div className="flex items-center gap-3 px-4 py-2 bg-card border-b border-border shrink-0 overflow-x-auto">
        {/* My status */}
        <div className={`flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full ${sharing && myLoc ? "bg-green-100 text-green-700" : "bg-muted text-muted-foreground"}`}>
        ...
        {/* Other's status */}
        <div className={`flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full ${otherIsOnline ? "bg-blue-100 text-blue-700" : "bg-muted text-muted-foreground"}`}>
        ...
        {distance !== null && (
          <div className="flex items-center gap-1 text-xs font-semibold text-orange-600 bg-orange-50 px-2.5 py-1 rounded-full ml-auto shrink-0">
